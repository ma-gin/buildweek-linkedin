...
<ResourcesCardSec icons={'bi bi-people-fill mr-2'} titleText={'Mine network'} description={'Save and edit your network.'} border={{borderBottom: '1px solid gray', marginBottom:'10px'}}/>
